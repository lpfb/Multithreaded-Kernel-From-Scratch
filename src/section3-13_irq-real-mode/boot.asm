...
handle_zero: ; ISR for INT 0
    mov al, 'A' ; Will be written to the screen
    call print_char
    iret ; return from interrupt

handle_one: ; ISR for INT 1
    mov al, 'B' ; Will be written to the screen
    call print_char
    iret ; return from interrupt
...
step2:
    ...
    ; Adding handle_zero to IRQ table position 0
    mov word[ss:0x00], handle_zero ; Function to be called (ISR)
    mov word[ss:0x02], 0x7c0
    
    ; Adding handle_one to IRQ table position 1
    mov word[ss:0x04], handle_one ; Function to be called (ISR)
